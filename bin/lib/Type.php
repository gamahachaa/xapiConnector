...
class Type {
	...
	public static function getClass ($o) {
		...
		if (is_object($o) && !($o instanceof HxClass) && !($o instanceof HxEnum)) {
			...
			#C:\HaxeToolkit\haxe\std/php/_std/Type.hx:45: characters 11-54
			if ($cls === Boot::getClass(HxAnon::class)) {
				#C:\HaxeToolkit\haxe\std/php/_std/Type.hx:45: characters 38-42
				return null;
			} else {
				#C:\HaxeToolkit\haxe\std/php/_std/Type.hx:45: characters 45-53
				return $cls;
			}
		} else if (is_string($o)) {
