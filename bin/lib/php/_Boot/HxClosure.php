...
class HxClosure {
	...
	public function __construct ($target, $func) {
		#C:\HaxeToolkit\haxe\std/php/Boot.hx:983: characters 3-23
		$this->target = $target;
		#C:\HaxeToolkit\haxe\std/php/Boot.hx:984: characters 3-19
		$this->func = $func;
		#C:\HaxeToolkit\haxe\std/php/Boot.hx:986: lines 986-988
		if (\is_null($target)) {
			#C:\HaxeToolkit\haxe\std/php/Boot.hx:987: characters 4-9
			throw Exception::thrown("Unable to create closure on `null`");
		}
		#C:\HaxeToolkit\haxe\std/php/Boot.hx:989: characters 3-104
	...
	public function __invoke () {
		#C:\HaxeToolkit\haxe\std/php/Boot.hx:997: characters 3-71
	...
	public function callWith ($newThis, $args) {
		#C:\HaxeToolkit\haxe\std/php/Boot.hx:1024: characters 3-65
	...
	public function equals ($closure) {
		#C:\HaxeToolkit\haxe\std/php/Boot.hx:1017: characters 10-60
		if (Boot::equal($this->target, $closure->target)) {
			#C:\HaxeToolkit\haxe\std/php/Boot.hx:1017: characters 39-59
	...
	public function getCallback ($eThis = null) {
		#C:\HaxeToolkit\haxe\std/php/Boot.hx:1004: lines 1004-1006
		if ($eThis === null) {
			#C:\HaxeToolkit\haxe\std/php/Boot.hx:1005: characters 4-18
			$eThis = $this->target;
		}
		#C:\HaxeToolkit\haxe\std/php/Boot.hx:1007: lines 1007-1009
		if (($eThis instanceof HxAnon)) {
			#C:\HaxeToolkit\haxe\std/php/Boot.hx:1008: characters 4-36
			return $eThis->{$this->func};
		}
		#C:\HaxeToolkit\haxe\std/php/Boot.hx:1010: characters 3-39
		return [$eThis, $this->func];
	}
}
