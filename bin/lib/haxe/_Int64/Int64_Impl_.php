...
final class Int64_Impl_ {
	...
	public static function divMod ($dividend, $divisor) {
		#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:172: lines 172-179
		if ($divisor->high === 0) {
			#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:173: characters 12-23
			$__hx__switch = ($divisor->low);
			if ($__hx__switch === 0) {
				#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:175: characters 6-11
				throw Exception::thrown("divide by zero");
			} else if ($__hx__switch === 1) {
				#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:177: characters 24-39
				$this1 = new ___Int64($dividend->high, $dividend->low);
				#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:177: characters 50-51
				$this2 = new ___Int64(0, 0);
				#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:177: characters 6-52
				return new HxAnon([
					"quotient" => $this1,
					"modulus" => $this2,
				]);
		...
		#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:181: characters 3-53
		$divSign = ($dividend->high < 0) !== ($divisor->high < 0);
		#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:183: characters 3-64
		$modulus = null;
		#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:183: characters 17-63
		if ($dividend->high < 0) {
			#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:183: characters 36-45
			...
			#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:183: characters 48-63
			$this1 = new ___Int64($dividend->high, $dividend->low);
			#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:183: characters 3-64
			$modulus = $this1;
		}
		#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:184: characters 13-49
		if ($divisor->high < 0) {
			#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:184: characters 31-39
		...
		#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:186: characters 3-26
		$this1 = new ___Int64(0, 0);
		$quotient = $this1;
		#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:187: characters 3-22
		$this1 = new ___Int64(0, 1);
		$mask = $this1;
		#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:189: lines 189-195
		while (!($divisor->high < 0)) {
			#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:190: characters 14-40
			$v = Int32_Impl_::ucompare($divisor->high, $modulus->high);
			#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:190: characters 4-41
			$cmp = ($v !== 0 ? $v : Int32_Impl_::ucompare($divisor->low, $modulus->low));
			#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:191: characters 4-17
			$b = 1;
			$b &= 63;
			if ($b === 0) {
			...
			#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:192: characters 4-14
			$b1 = 1;
			$b1 &= 63;
			if ($b1 === 0) {
			...
			#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:193: lines 193-194
			if ($cmp >= 0) {
				#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:194: characters 5-10
				break;
			}
		}
		#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:197: lines 197-204
		while (true) {
			#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:197: characters 10-19
			$b_high = 0;
			$b_low = 0;
			#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:197: lines 197-204
			...
			#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:198: characters 8-34
			$v = Int32_Impl_::ucompare($modulus->high, $divisor->high);
			#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:198: lines 198-201
			if ((($v !== 0 ? $v : Int32_Impl_::ucompare($modulus->low, $divisor->low))) >= 0) {
				#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:199: characters 5-21
				...
				$quotient = $this1;
				#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:200: characters 5-23
			...
			#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:202: characters 4-15
			$b = 1;
			$b &= 63;
			if ($b === 0) {
			...
			#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:203: characters 4-18
			$b1 = 1;
			$b1 &= 63;
			if ($b1 === 0) {
		...
		#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:206: lines 206-207
		if ($divSign) {
			#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:207: characters 15-24
		...
		#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:208: lines 208-209
		if ($dividend->high < 0) {
			#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:209: characters 14-22
		...
		#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:211: lines 211-214
		return new HxAnon([
			"quotient" => $quotient,
			"modulus" => $modulus,
		]);
	...
	public static function isInt64 ($val) {
		#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:77: characters 3-36
	...
	public static function toString ($this1) {
		#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:133: characters 3-27
		$i = $this1;
		#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:134: characters 7-13
		$b_high = 0;
		$b_low = 0;
		#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:134: lines 134-135
		if (($i->high === $b_high) && ($i->low === $b_low)) {
			#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:135: characters 4-14
			return "0";
		}
		#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:136: characters 3-16
		$str = "";
		#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:137: characters 3-19
		$neg = false;
		#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:138: lines 138-141
		if ($i->high < 0) {
			#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:139: characters 4-7
			$neg = true;
		}
		#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:142: characters 3-22
		$this1 = new ___Int64(0, 10);
		$ten = $this1;
		#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:143: lines 143-152
		while (true) {
			#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:143: characters 10-16
			$b_high = 0;
			$b_low = 0;
			#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:143: lines 143-152
			if (!(($i->high !== $b_high) || ($i->low !== $b_low))) {
			...
			#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:144: characters 4-26
			$r = Int64_Impl_::divMod($i, $ten);
			#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:145: lines 145-151
			if ($r->modulus->high < 0) {
				#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:146: characters 11-31
				$x = $r->modulus;
				...
				$this_high = $high;
				$this_low = $low;
				#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:146: characters 5-8
				$str = ($this_low??'null') . ($str??'null');
				#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:147: characters 9-30
				$x1 = $r->quotient;
				...
				#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:149: characters 5-8
				$str = ($r->modulus->low??'null') . ($str??'null');
				#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:150: characters 5-6
				$i = $r->quotient;
			}
		}
		#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:153: lines 153-154
		if ($neg) {
			#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:154: characters 4-7
			$str = "-" . ($str??'null');
		}
		#C:\HaxeToolkit\haxe\std/haxe/Int64.hx:155: characters 3-13
		return $str;
	}
}
