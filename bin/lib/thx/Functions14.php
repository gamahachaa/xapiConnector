...
class Functions14 {
	...
	public static function curry ($f) {
		#C:\HaxeToolkit\haxe\lib\thx,core/git/src/thx/Functions.hx:355: lines 355-359
		return function ($a, $b, $c, $d, $e, $f0, $g, $h, $i, $j, $k, $l, $m) use (&$f) {
			#C:\HaxeToolkit\haxe\lib\thx,core/git/src/thx/Functions.hx:356: lines 356-358
			return function ($n) use (&$m, &$f, &$g, &$c, &$l, &$e, &$k, &$f0, &$i, &$j, &$b, &$d, &$a, &$h) {
				#C:\HaxeToolkit\haxe\lib\thx,core/git/src/thx/Functions.hx:357: characters 5-56
